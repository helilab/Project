 ...
 * C source code generated on : Mon Feb 13 13:47:03 2017
 *
...
void helicopter_output(void)
{
   ...
   *  Sum: '<S5>/Sum3'
   */
  helicopter_B.Sum_k = ((helicopter_P.pitch_ref_Value - helicopter_P.Gain1_Gain *
    helicopter_B.Gain_i) * helicopter_P.K_pp - helicopter_P.Gain1_Gain *
                        helicopter_B.Gain_b * helicopter_P.K_pd) +
    helicopter_P.Vd_ff;
  if (rtmIsMajorTimeStep(helicopter_M)) {
  }
   ...
   */
  rtb_Gain1_idx_4 = helicopter_P.elevation_ref_Value - rtb_Gain1_idx_4;
   ...
   *  Sum: '<S3>/Sum1'
   */
  helicopter_B.Sum2 = ((helicopter_P.K_ep * rtb_Gain1_idx_4 + rtb_Backgain) -
  ...
  /* Gain: '<S3>/K_ei' */
  helicopter_B.K_ei = helicopter_P.K_ei * rtb_Gain1_idx_4;
  if (rtmIsMajorTimeStep(helicopter_M)) {
  }
  ...
  if ((helicopter_DW.TimeStampA >= helicopter_M->Timing.t[0]) &&
    ...
    rtb_Gain1_idx_4 = helicopter_DW.TimeStampA;
    ...
    if (helicopter_DW.TimeStampA < helicopter_DW.TimeStampB) {
      if (helicopter_DW.TimeStampB < helicopter_M->Timing.t[0]) {
        rtb_Gain1_idx_4 = helicopter_DW.TimeStampB;
    ...
    rtb_Gain1_idx_4 = (helicopter_B.PitchCounttorad - *lastU) /
      (helicopter_M->Timing.t[0] - rtb_Gain1_idx_4);
  }

  /* End of Derivative: '<S4>/Derivative' */

  /* Gain: '<S10>/Gain' */
  helicopter_B.Gain_l = helicopter_P.Gain_Gain_a1 * rtb_Gain1_idx_4;
  if (rtmIsMajorTimeStep(helicopter_M)) {
  }
   ...
   *  Sum: '<S1>/Add'
   */
  rtb_Gain1_idx_4 = (helicopter_B.Sum_k + helicopter_B.Sum2) *
    helicopter_P.Frontgain_Gain;

  /* Saturate: '<S4>/Front motor: Saturation' */
  if (rtb_Gain1_idx_4 > helicopter_P.FrontmotorSaturation_UpperSat) {
    helicopter_B.FrontmotorSaturation =
      helicopter_P.FrontmotorSaturation_UpperSat;
  } else if (rtb_Gain1_idx_4 < helicopter_P.FrontmotorSaturation_LowerSat) {
    helicopter_B.FrontmotorSaturation =
      helicopter_P.FrontmotorSaturation_LowerSat;
  } else {
    helicopter_B.FrontmotorSaturation = rtb_Gain1_idx_4;
  }
...
RT_MODEL_helicopter_T *helicopter(void)
{
  ...
  /* External mode info */
  helicopter_M->Sizes.checksums[0] = (662447188U);
  helicopter_M->Sizes.checksums[1] = (126269504U);
  helicopter_M->Sizes.checksums[2] = (3197678170U);
  helicopter_M->Sizes.checksums[3] = (1946992690U);
  ...
  helicopter_M->Sizes.numBlocks = (53);/* Number of blocks */
  helicopter_M->Sizes.numBlockIO = (16);/* Number of block outputs */
  helicopter_M->Sizes.numBlockPrms = (142);/* Sum of parameter "widths" */
  return helicopter_M;
}
